    ...
    return (
        <View style={styles.container}>
            ...
            >
                ...
                {/* ---------------- Map ---------------- */}
                {/* The planned journey only (MOV-293). The live bus position
                    belongs to the ongoing-journey map, not to a journey the
                    passenger has not booked yet, so no `vehicle` is passed. */}
                <RouteMapCard
                    geo={geo}
